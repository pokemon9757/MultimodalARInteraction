...
#pragma warning restore 414
        ...
        private void Initialize()
        {
            ...
            if (_indexFinger.Count > 0)
            {
                _indexFinger[0].gameObject.name = "Top index";
                _indexFinger[0].gameObject.AddComponent<SphereCollider>();
            }
            // Thumb
            ...
            if (_thumb.Count > 0)
            {
                _thumb[0].gameObject.name = "Top thumb";
                _thumb[0].gameObject.AddComponent<SphereCollider>();
            }
