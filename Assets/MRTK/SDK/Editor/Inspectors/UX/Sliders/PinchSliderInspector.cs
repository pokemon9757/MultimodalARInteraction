    ...
    public class PinchSliderInspector : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            if (slider != null)
            {
                ...
                var fmh_49_21_638203657658194453 = Quaternion.identity; slider.SliderStartPosition = Handles.FreeMoveHandle(startPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
                var fmh_54_21_638203657658226919 = Quaternion.identity; slider.SliderEndPosition = Handles.FreeMoveHandle(endPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
